                ...
                <div class="example">
                  <div id="toolbar" class="btn-group m-t-sm">
                    <shiro:hasPermission name="administrator:list:create">
                      <button type="button" class="btn btn-default"  title="创建管理员" onclick="layer_show('创建管理员','${ctx}/administrator/list/create','900','700')"> <i class="glyphicon glyphicon-plus"></i> </button>
                    </shiro:hasPermission>
                  </div>
                  <table id="table"
                         data-toggle="table"
                         ...
                         data-url="${ctx}/administrator/list/"
