...
<div id="wrapper"> 
      ...
      <ul class="nav" id="side-menu">
        <li class="nav-header">
          <div class="dropdown profile-element"> <span>
            <%--<img src="${ctximg}/${user.picImg}" alt="头像加载中..." class="img-circle" style="width: 64px; height: 64px;"> --%>
          </span> <a data-toggle="dropdown" class="dropdown-toggle" href="#"> <span class="clear"> <span class="block m-t-xs"><strong class="font-bold">${user.userName}</strong></span> <span class="text-muted text-xs block">${user.organizationName}<b class="caret"></b></span> </span> </a>
            <ul class="dropdown-menu animated fadeInRight m-t-xs">
              <%--<li><a class="J_menuItem" href="${ctx}/administrator/info/avatar">修改头像</a> </li>--%>
              <li><a class="J_menuItem" href="${ctx}/administrator/info/view">个人资料</a> </li>
  ...
  <div id="page-wrapper" class="gray-bg dashbard-1">
    ...
    <div class="footer">
      <div class="pull-right">© 2016-2018<a href="http://wpa.qq.com/msgrd?v=3&uin=810170512&site=qq&menu=yes" target="_Blank"> 穿鞋子的猫 </a>
    </div>
  </div>
  <!--右侧部分结束--> 
  <!--右侧边栏开始-->
        ...
        <div id="tab-2" class="tab-pane">
          ...
          <div>
            <div class="sidebar-message"> <a href="#">
              <div class="pull-left text-center"> <img alt="image" class="img-circle message-avatar" src="">
            ...
            <div class="sidebar-message"> <a href="#">
              <div class="pull-left text-center"> <img alt="image" class="img-circle message-avatar" src=""> </div>
