    ...
    <div class="col-sm-12">
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          <form id="form" class="form-horizontal" action="${ctx}/administrator/organization/${organization.organizationId}" data-method="put">
            <div class="form-group m-t">
              <label class="col-sm-2 col-xs-offset-1 control-label">组织名称：</label>
              <div class="col-sm-7">
                <input type="text" maxlength="10" class="form-control" name="organizationName" value="${organization.organizationName}">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <label class="radio-inline">
                  <input type="radio" name="isSystem" value="1" ${organization.isSystem eq '1'?'checked="checked"':''}>
                  是</label>
                <label class="radio-inline">
                  <input type="radio" name="isSystem" value="0" ${organization.isSystem eq '0'?'checked="checked"':''}>
                  否</label>
