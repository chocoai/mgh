    ...
    <div class="col-sm-12">
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          <form id="form" class="form-horizontal" action="${ctx}/online/advert/${advert.advertId}/detail" data-method="post">
            ...
            <c:if test="${advert.type eq 0}">
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <textarea class="form-control" rows="2" name="content" placeholder="请输入广告内容..."></textarea>
                </div>
              </div>
              <div class="hr-line-dashed"></div>
            </c:if>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <div class="input-group date form_datetime">
                  <input class="form-control" size="16" type="text" name="beginTime" readonly>
