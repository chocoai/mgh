    ...
    <div class="col-sm-12">
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          <form id="form" class="form-horizontal" action="${ctx}/online/navigation/${navigation.navigationId}/bar" data-method="post">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <select class="form-control" name="target">
                  <option value="_blank">在新窗口中打开被链接文档 </option>
                  <option value="_self">在相同的框架中打开被链接文档</option>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-7">
                <input type="text" maxlength="10" class="form-control" name="sort">
              </div>
            </div>
            <div class="hr-line-dashed"></div>       
            <div class="form-group">
