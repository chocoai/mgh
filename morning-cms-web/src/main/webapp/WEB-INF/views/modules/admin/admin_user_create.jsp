    ...
    <div class="col-sm-12">
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          <form id="form" class="form-horizontal" action="${ctx}/administrator/list" data-method="post">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" maxlength="11" class="form-control" name="userName">
              </div>
            </div>
            <div class="hr-line-dashed"></div>
            <div class="form-group">
