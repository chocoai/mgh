...
public class WebFrontController extends BaseController {
	...
	public String index(Model model) {
		...
		System.out.println("******************************************************:  "+indexCarouselImgs);
		...
		System.out.println("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$:  "+indexHotAdvertImgs);
		model.addAttribute("indexHotAdvertImgs", indexHotAdvertImgs);
		System.out.println("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&:  "+AdvertTypeEnum.INDEX_CAROUSEL.getType()+" ?? "+AdvertTypeEnum.INDEX_HOT_ADVERT.getType());
